    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_id', models.CharField(blank=True, editable=False, help_text="The Message ID of the submitter's email.", max_length=256, null=True, verbose_name='E-Mail ID')),
                ('time_spent', models.DurationField(blank=True, help_text='Time spent on this follow up', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, verbose_name='Title on knowledgebase page')),
                ('slug', models.SlugField(verbose_name='Slug')),
                ('description', models.TextField(verbose_name='Description')),
                ('public', models.BooleanField(default=True, verbose_name='Is KBCategory publicly visible?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True, verbose_name='Enabled to display to users')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.kbcategory', verbose_name='Category')),
                ('downvoted_by', models.ManyToManyField(related_name='downvotes', to=settings.AUTH_USER_MODEL)),
                ('team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SB.kbitem', verbose_name='SB.KBItem')),
                ('voted_by', models.ManyToManyField(related_name='votes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_box_local_dir', models.CharField(blank=True, help_text='If using a local directory, what directory path do you wish to poll for new email? Example: /var/lib/mail/helpdesk/', max_length=200, null=True, verbose_name='E-Mail Local Directory')),
                ...
                ('logging_dir', models.CharField(blank=True, help_text='If logging is enabled, what directory should we use to store log files for this queue? The standard logging mechanims are used if no directory is set', max_length=200, null=True, verbose_name='Logging Directory')),
                ('dedicated_time', models.DurationField(blank=True, help_text='Time to be spent on this Queue in total', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(default=SB.models.mk_secret, max_length=36, verbose_name='Secret key needed for viewing/editing ticket by non-logged in users')),
                ...
                ('kbitem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SB.kbitem', verbose_name='Knowledge base item the user was viewing when they created this ticket.')),
                ('merged_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='merged_tickets', to='SB.ticket', verbose_name='merged to')),
                ('queue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.queue', verbose_name='Queue')),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('settings_pickled', models.TextField(blank=True, help_text='DEPRECATED! This is a base64-encoded representation of a pickled Python dictionary. Do not change this field via the admin.', null=True, verbose_name='DEPRECATED! Settings Dictionary DEPRECATED!')),
                ('login_view_ticketlist', models.BooleanField(default=SB.models.login_view_ticketlist_default, help_text='Display the ticket list upon login? Otherwise, the dashboard is shown.', verbose_name='Show Ticket List on Login?')),
                ('email_on_ticket_change', models.BooleanField(default=SB.models.email_on_ticket_change_default, help_text="If you're the ticket owner and the ticket is changed via the web by somebody else,do you want to receive an e-mail?", verbose_name='E-mail me on ticket change?')),
                ('email_on_ticket_assign', models.BooleanField(default=SB.models.email_on_ticket_assign_default, help_text='If you are assigned a ticket via the web, do you want to receive an e-mail?', verbose_name='E-mail me when assigned a ticket?')),
                ('tickets_per_page', models.IntegerField(choices=[(10, '10'), (25, '25'), (50, '50'), (100, '100')], default=SB.models.tickets_per_page_default, help_text='How many tickets do you want to see on the Ticket List page?', verbose_name='Number of tickets to show per page')),
                ('use_email_as_submitter', models.BooleanField(default=SB.models.use_email_as_submitter_default, help_text='When you submit a ticket, do you want to automatically use your e-mail address as the submitter address? You can type a different e-mail address when entering the ticket if needed, this option only changes the default.', verbose_name='Use my e-mail address when submitting tickets?')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='usersettings_helpdesk', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.followup', verbose_name='Follow-up')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.ticket', verbose_name='Ticket')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues', models.ManyToManyField(blank=True, help_text='Leave blank to allow this reply to be used for all queues, or select those queues you wish to limit this reply to.', to='SB.Queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=1000, upload_to=SB.models.attachment_path, verbose_name='File')),
                ...
                ('kbitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.kbitem', verbose_name='Knowledge base item')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues', models.ManyToManyField(blank=True, help_text='Leave blank for this e-mail to be ignored on all queues, or select those queues you wish to ignore this e-mail for.', to='SB.Queue')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='followup',
            name='ticket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.ticket', verbose_name='Ticket'),
        ),
        migrations.AddField(
            model_name='followup',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queues', models.ManyToManyField(blank=True, help_text='Leave blank for this exclusion to be applied to all queues, or select those queues you wish to exclude with this entry.', to='SB.Queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('depends_on', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depends_on', to='SB.ticket', verbose_name='Depends On Ticket')),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticketdependency', to='SB.ticket', verbose_name='Ticket')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.customfield', verbose_name='Field')),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SB.ticket', verbose_name='Ticket')),
            ],
            options={
